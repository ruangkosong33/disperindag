...
@section('breadcrum')
    @include('components.guest.breadcumb', ['title' => 'Permohonan Informasi'])
@endsection
...
@section('content')
    <div class="space" id="contact-sec">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="contact-form-wrap" data-bg-src="{{asset('assets/img/bg/contact_bg_1.png')}}">
                        ...
                        <form action="{{ route('permohonan.informasi.request.ppid') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="kategori_permohonan" id=""
                                ...
                                <div class="col-12">
                                    <div class="form-group ">
                                        <textarea name="tujuan" id="message" cols="30" rows="3" class="form-control style-white"
