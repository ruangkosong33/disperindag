            ...
            <div class="footer-contact-wrap">
                <div class="footer-contact">
                    ...
                    <div class="media-body">
                        <p class="footer-contact_text">Hubungi kapan pun:</p>
                ...
                <div class="footer-contact">
                    ...
                    <div class="media-body">
                        <p class="footer-contact_text">Email kami 24/7 jam:</p>
                        <a href="mailto:info@edura.com" class="footer-contact_link">indagkop@kaltimprov.com</a>
                    </div>
                </div>
                <div class="divider"></div>
                <div class="footer-contact">
                    ...
                    <div class="media-body">
                        <p class="footer-contact_text">Lokasi kami:</p>
                        <a href="https://www.google.com/maps" class="footer-contact_link">Samarinda</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6 col-xl-auto">
                        <div class="widget widget_nav_menu footer-widget">
                            <h3 class="widget_title">JAM PELAYANAN</h3>
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    <li><a href="#">Senin – Kamis : 08.00 – 16.30</a></li>
                                    <li><a href="#">Jumat : 08.00 – 12.00</a></li>
                                    <li><a href="#">Sabtu – Minggu : Tutup</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
